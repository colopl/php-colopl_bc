--TEST--
Check for \Colopl\ColoplBc\Php74\ksort() function. (colopl_bc.php74.compare_mode=3)
--EXTENSIONS--
colopl_bc
--INI--
date.timezone=UTC
...
--SKIPIF--
<?php if (PHP_VERSION_ID < 80000) die("skip PHP 8 compatibility diagnostics only"); if (PHP_VERSION_ID >= 80200) print 'skip require 8.2 > PHP'; ?>
--FILE--
<?php
